...
const Login = () => {
    ...
    return (
        <div className="container-fluid d-flex justify-content-center align-items-center vh-100" 
            ...
            `}</style>
            <div className="card login-card shadow-2xl p-4 p-md-5" style={{ width: '100%', maxWidth: '420px' }}>
                ...
                {generalError && <div className="alert alert-danger border-0 small text-center py-2 rounded-3">{generalError}</div>}
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="btn btn-primary btn-login w-100 fw-bold text-white" disabled={isLoading}>
