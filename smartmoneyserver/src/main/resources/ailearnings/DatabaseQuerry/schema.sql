...
(1, 1, 5000000, 3000000, '2026-03-31 23:59:59', N'Cho anh Minh vay tiền khẩn cấp', 0, '2025-12-10 14:30:00'),
-- User 2 - Mai Trần
(2, 1, 500000, 500000, '2029-07-30 23:59:59', N'Cho bạn A vay', 0, '2025-01-15 09:00:00'),
(2, 0, 3000000, 1500000, '2026-04-15 23:59:59', N'Vay bố mẹ mua iPhone', 0, '2026-01-20 11:00:00'),
-- User 3 - Nam Lê
(3, 1, 2000000, 2000000, '2026-05-20 23:59:59', N'Cho em trai vay học phí', 0, '2026-02-01 08:00:00'),
(3, 0, 10000000, 7000000, '2026-12-31 23:59:59', N'Vay bạn thân mua laptop', 0, '2025-10-15 16:30:00'),
-- User 5 
(5, 0, 50000000, 40000000, '2027-12-31 23:59:59', N'Vay ngân hàng cưới', 0, '2025-06-01 09:30:00'),
(5, 1, 8000000, 5000000, '2026-08-30 23:59:59', N'Cho đồng nghiệp vay mua xe', 0, '2025-11-20 13:00:00'),
-- User 6
(6, 1, 3500000, 3500000, '2026-07-15 23:59:59', N'Cho chị gái vay đi du lịch', 0, '2026-01-25 10:45:00'),
-- User 7
(7, 0, 15000000, 12000000, '2026-09-30 23:59:59', N'Vay bố tiền mua MacBook', 0, '2025-12-05 15:00:00'),
-- User 8
(8, 1, 4000000, 1500000, '2026-06-10 23:59:59', N'Cho bạn cùng phòng vay tiền nhà', 0, '2025-09-01 12:00:00'),
-- User 10
(10, 0, 25000000, 20000000, '2027-06-30 23:59:59', N'Vay mẹ mua nhẫn cưới', 0, '2025-08-20 11:30:00'),
(10, 1, 6000000, 6000000, '2026-10-31 23:59:59', N'Cho em họ vay tiền sửa xe', 0, '2026-01-10 09:15:00'),
-- User 11
(11, 0, 35000000, 28000000, '2028-12-31 23:59:59', N'Vay ngân hàng đầu tư chứng khoán', 0, '2024-11-01 10:00:00'),
-- User 12
(12, 1, 10000000, 7000000, '2026-11-20 23:59:59', N'Cho anh trai vay sửa nhà', 0, '2025-07-30 14:00:00'),
-- User 14
(14, 0, 7000000, 5000000, '2026-05-31 23:59:59', N'Vay công ty tiền ứng lương', 0, '2025-11-15 08:30:00'),
-- User 15
(15, 1, 12000000, 12000000, '2027-03-31 23:59:59', N'Cho bạn học vay tiền học Thạc sĩ', 0, '2026-01-05 13:20:00'),
-- User 17
(17, 0, 100000000, 80000000, '2029-12-31 23:59:59', N'Vay ngân hàng khởi nghiệp', 0, '2024-06-15 09:00:00'),
-- User 18
(18, 1, 5500000, 2500000, '2026-08-15 23:59:59', N'Cho cháu vay mua điện thoại', 0, '2025-10-20 16:00:00'),
-- User 20
(20, 0, 18000000, 15000000, '2027-02-28 23:59:59', N'Vay bạn thân mua máy ảnh', 0, '2025-09-10 11:00:00');
GO
...
GO
-- ======================================================================
-- DỮ LIỆU MẪU: Giao dịch định kỳ/Hóa đơn (tPlannedTransactions)
-- ======================================================================
-- PHÂN LOẠI ĐÚNG:
--   ✅ BILLS (plan_type=1): Số tiền THAY ĐỔI mỗi kỳ, cần duyệt tay
--      VD: Điện, nước, gas, chi phí y tế...
--   ✅ RECURRING (plan_type=2): Số tiền CỐ ĐỊNH, tự động tạo giao dịch
--      VD: Internet, Netflix, lương, trả góp, bảo hiểm, học phí...
-- ======================================================================
GO

-- ══════════════════════════════════════════════════════════════════════
-- NHÓM 1: BILLS (plan_type = 1) - Số tiền THAY ĐỔI
-- ══════════════════════════════════════════════════════════════════════
...
-- ────────────────────────────────────────────────────────────────────
-- Bills - Hóa đơn điện (số tiền dao động)
-- ────────────────────────────────────────────────────────────────────
(1, 2, 28, N'Hóa đơn tiền điện EVN',
 520000, 1, 1, 3, 1, NULL,
 '2026-01-08', '2026-03-08', '2026-02-08', NULL, 1),
-- 💡 Tháng 1: 480k, Tháng 2: 520k, Tháng 3: dự kiến 500k (thay đổi theo mức tiêu thụ)

(2, 4, 28, N'Hóa đơn tiền điện (Căn hộ)',
 680000, 1, 1, 3, 1, NULL,
 '2026-01-05', '2026-03-05', '2026-02-05', NULL, 1),
-- 💡 Căn hộ lớn nên tiền điện dao động 650k-750k

(6, 10, 28, N'Hóa đơn điện (Nhà riêng)',
 450000, 1, 1, 3, 1, NULL,
 '2026-01-20', '2026-03-20', '2026-02-20', NULL, 1),
-- 💡 Nhà nhỏ tiền điện thấp hơn 400k-500k

-- ────────────────────────────────────────────────────────────────────
-- Bills - Hóa đơn nước (số tiền dao động)
-- ────────────────────────────────────────────────────────────────────
(1, 2, 32, N'Hóa đơn tiền nước Cấp nước TP',
 85000, 1, 1, 3, 1, NULL,
 '2026-01-10', '2026-03-10', '2026-02-10', NULL, 1),
-- 💡 Nước thường dao động 70k-100k tùy mức tiêu thụ

(3, 6, 32, N'Tiền nước hàng tháng',
 120000, 1, 1, 3, 1, NULL,
 '2026-01-12', '2026-03-12', '2026-02-12', NULL, 1),
-- 💡 Gia đình đông người dùng nhiều nước 100k-150k

-- ────────────────────────────────────────────────────────────────────
-- Bills - Hóa đơn gas (số tiền dao động)
-- ────────────────────────────────────────────────────────────────────
(2, 3, 30, N'Hóa đơn gas Petrolimex',
 320000, 1, 1, 3, 1, NULL,
 '2026-01-15', '2026-03-15', '2026-02-15', NULL, 1),
-- 💡 Gas thay bình không đều, có thể 0đ (không thay) hoặc 300k-350k

(11, 18, 30, N'Gas nấu ăn',
 280000, 1, 1, 3, 1, NULL,
 '2026-01-18', '2026-03-18', '2026-02-18', NULL, 1),
-- 💡 Gas dao động 250k-350k tùy mức tiêu thụ

-- ────────────────────────────────────────────────────────────────────
-- Bills - Chi phí y tế (không biết trước)
-- ────────────────────────────────────────────────────────────────────
(3, 5, 38, N'Khám sức khỏe định kỳ',
 650000, 1, 1, 4, 1, NULL,
 '2026-01-15', '2027-01-15', '2026-01-15', NULL, 1),
-- 💡 Chi phí khám định kỳ hàng năm dao động tùy gói khám

(8, 21, 38, N'Chi phí y tế gia đình',
 1200000, 1, 1, 3, 1, NULL,
 '2026-02-01', '2026-03-01', '2026-02-01', '2026-06-30', 1),
-- 💡 Chi phí chữa bệnh không ổn định, có tháng 0đ có tháng vài triệu

-- ══════════════════════════════════════════════════════════════════════
-- NHÓM 2: RECURRING (plan_type = 2) - Số tiền CỐ ĐỊNH
-- ══════════════════════════════════════════════════════════════════════

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Internet/TV Cable (gói cước cố định)
-- ────────────────────────────────────────────────────────────────────
(1, 2, 31, N'Internet VNPT - Gói 200Mbps',
 280000, 2, 1, 3, 1, NULL,
 '2026-01-15', '2026-03-15', '2026-02-15', NULL, 1),
-- ✅ Gói cước internet CỐ ĐỊNH hàng tháng

(2, 4, 31, N'Internet FPT - Gói 300Mbps',
 350000, 2, 1, 3, 1, NULL,
 '2026-01-05', '2026-03-05', '2026-02-05', NULL, 1),
-- ✅ Gói cước internet CỐ ĐỊNH

(6, 10, 31, N'Internet Viettel - Gói 100Mbps',
 220000, 2, 1, 3, 1, NULL,
 '2026-01-20', '2026-03-20', '2026-02-20', NULL, 1),

(11, 18, 34, N'Truyền hình K+ Premium',
 180000, 2, 1, 3, 1, NULL,
 '2026-01-12', '2026-03-12', '2026-02-12', NULL, 1),
-- ✅ Gói truyền hình CỐ ĐỊNH

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Subscription services (Netflix, Spotify...)
-- ────────────────────────────────────────────────────────────────────
(11, 18, 25, N'Netflix Premium (Gói gia đình)',
 260000, 2, 1, 3, 1, NULL,
 '2026-01-12', '2026-03-12', '2026-02-12', NULL, 1),
-- ✅ Gói Netflix CỐ ĐỊNH hàng tháng
...
(3, 6, 25, N'YouTube Premium',
 79000, 2, 1, 3, 1, NULL,
 '2026-01-10', '2026-03-10', '2026-02-10', NULL, 1),
-- ✅ Gói YouTube Premium CỐ ĐỊNH

(17, 26, 25, N'ChatGPT Plus',
 440000, 2, 1, 3, 1, NULL,
 '2026-01-15', '2026-03-15', '2026-02-15', NULL, 1),
-- ✅ Subscription AI CỐ ĐỊNH ($20/tháng ~ 440k VND)

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Điện thoại/Mobile (gói cước cố định)
-- ────────────────────────────────────────────────────────────────────
(6, 10, 29, N'Gói cước Viettel - V90',
 90000, 2, 1, 3, 1, NULL,
 '2026-01-20', '2026-03-20', '2026-02-20', NULL, 1),
-- ✅ Gói cước di động CỐ ĐỊNH

(1, 2, 29, N'Gói cước VinaPhone - VD149',
 149000, 2, 1, 3, 1, NULL,
 '2026-01-05', '2026-03-05', '2026-02-05', NULL, 1),

(11, 18, 29, N'Gói cước MobiFone - MAX200',
 200000, 2, 1, 3, 1, NULL,
 '2026-01-10', '2026-03-10', '2026-02-10', NULL, 1),

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Thuê nhà (cố định hàng tháng)
-- ────────────────────────────────────────────────────────────────────
(2, 4, 34, N'Tiền thuê căn hộ Vinhomes',
 8500000, 2, 1, 3, 1, NULL,
 '2026-01-05', '2026-03-05', '2026-02-05', NULL, 1),
-- ✅ Tiền thuê nhà CỐ ĐỊNH theo hợp đồng

(9, 15, 34, N'Tiền thuê trọ',
 3200000, 2, 1, 3, 1, NULL,
 '2026-01-08', '2026-03-08', '2026-02-08', '2026-12-31', 1),
-- ✅ Thuê trọ CỐ ĐỊNH đến khi hết hợp đồng

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Phí bảo hiểm (cố định)
-- ────────────────────────────────────────────────────────────────────
(3, 6, 2, N'Phí bảo hiểm nhân thọ Prudential',
 8400000, 2, 1, 4, 1, NULL,
 '2026-01-20', '2027-01-20', '2026-01-20', '2030-01-20', 1),
-- ✅ Bảo hiểm hàng NĂM, phí CỐ ĐỊNH theo hợp đồng

(1, 2, 2, N'Bảo hiểm xe ô tô',
 6500000, 2, 1, 4, 1, NULL,
 '2026-02-01', '2027-02-01', '2026-02-01', NULL, 1),
-- ✅ Bảo hiểm xe hàng năm CỐ ĐỊNH

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Học phí (cố định theo học kỳ)
-- ────────────────────────────────────────────────────────────────────
(15, 23, 8, N'Học phí Đại học FPT - Học kỳ Spring',
 16500000, 2, 1, 4, 6, NULL,
 '2026-02-06', '2027-02-06', '2026-02-06', '2028-06-30', 1),
-- ✅ Học phí mỗi KỲ CỐ ĐỊNH (6 tháng/lần)

(12, 19, 8, N'Học phí THPT Chuyên',
 4500000, 2, 1, 4, 1, NULL,
 '2026-01-15', '2027-01-15', '2026-01-15', '2029-06-30', 1),
-- ✅ Học phí hàng NĂM CỐ ĐỊNH

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Lương hàng tháng (thu nhập cố định)
-- ────────────────────────────────────────────────────────────────────
(1, 2, 15, N'Lương tháng - Công ty ABC Tech',
 15000000, 2, 2, 3, 1, NULL,
 '2026-01-05', '2026-03-05', '2026-02-05', NULL, 1),
-- ✅ Lương CỐ ĐỊNH hàng tháng (trans_type = 2: Thu)

(11, 18, 15, N'Lương tháng - Ngân hàng XYZ',
 28000000, 2, 2, 3, 1, NULL,
 '2026-01-05', '2026-03-05', '2026-02-05', NULL, 1),

(17, 26, 15, N'Lương freelance',
 12000000, 2, 2, 3, 1, NULL,
 '2026-01-10', '2026-03-10', '2026-02-10', NULL, 1),

(3, 6, 16, N'Thu cổ tức đầu tư chứng khoán',
 2500000, 2, 2, 3, 1, NULL,
 '2026-01-28', '2026-03-28', '2026-02-28', NULL, 1),
-- ✅ Thu lãi CỐ ĐỊNH hàng tháng từ đầu tư

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Trả nợ/vay định kỳ (số tiền cố định)
-- ────────────────────────────────────────────────────────────────────
(5, 9, 22, N'Trả góp vay cưới - Ngân hàng Vietcombank',
 2000000, 2, 6, 3, 1, NULL,
 '2025-07-01', '2026-03-01', '2026-02-01', '2027-12-31', 1),
-- ✅ Trả nợ hàng tháng CỐ ĐỊNH (trans_type = 6: Trả nợ)

(3, 6, 22, N'Trả nợ bạn thân - Vay mua laptop',
 1000000, 2, 6, 3, 1, NULL,
 '2025-11-15', '2026-03-15', '2026-02-15', '2026-09-15', 1),

(10, 16, 22, N'Trả góp mua xe máy Honda Vision',
 3500000, 2, 6, 3, 1, NULL,
 '2025-08-01', '2026-03-01', '2026-02-01', '2027-08-01', 1),

(6, 10, 22, N'Trả góp mua iPhone 15 Pro',
 8000000, 2, 6, 3, 1, NULL,
 '2025-10-01', '2026-03-01', '2026-02-01', '2026-10-01', 1),

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Lặp lại hàng tuần (Bitmask: T2+T6 = 2+32 = 34)
-- ────────────────────────────────────────────────────────────────────
(7, 12, 1, N'Cafe sáng đầu tuần (T2, T6)',
 50000, 2, 1, 2, 1, 34,
 '2026-01-05', '2026-02-16', '2026-02-13', NULL, 1),
-- ✅ Chi cafe CỐ ĐỊNH mỗi T2 và T6

(1, 1, 1, N'Ăn trưa văn phòng (T2-T6)',
 70000, 2, 1, 2, 1, 62,
 '2026-02-03', '2026-02-14', '2026-02-13', NULL, 1),
-- ✅ Bitmask T2+T3+T4+T5+T6 = 2+4+8+16+32 = 62

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Lặp lại hàng ngày
-- ────────────────────────────────────────────────────────────────────
(5, 9, 1, N'Ăn sáng hàng ngày',
 40000, 2, 1, 1, 1, NULL,
 '2026-02-01', '2026-02-11', '2026-02-10', NULL, 1),
-- ✅ Chi CỐ ĐỊNH mỗi ngày

-- ────────────────────────────────────────────────────────────────────
-- Recurring - Đang tạm dừng (active = 0)
-- ────────────────────────────────────────────────────────────────────
(2, 3, 10, N'Mua sắm Shopee định kỳ',
 500000, 2, 1, 3, 1, NULL,
 '2025-10-01', '2026-03-01', '2026-02-01', NULL, 0);
-- ⏸️ Tạm dừng giao dịch định kỳ

GO

-- ======================================================================
-- THỐNG KÊ DỮ LIỆU ĐÃ SỬA
-- ======================================================================
-- ✅ BILLS (plan_type = 1): 11 rows
--    - Điện: 3 | Nước: 2 | Gas: 2 | Y tế: 4
--    - Đặc điểm: Số tiền THAY ĐỔI mỗi kỳ
--
-- ✅ RECURRING (plan_type = 2): 29 rows
--    - Internet/TV: 5 | Subscription: 4 | Mobile: 3
--    - Thuê nhà: 2 | Bảo hiểm: 2 | Học phí: 2
--    - Lương: 4 | Trả nợ: 4 | Lặp tuần: 2 | Lặp ngày: 1
--    - Đặc điểm: Số tiền CỐ ĐỊNH, tự động tạo giao dịch
--
-- TOTAL: 40 planned transactions
-- ======================================================================

PRINT '✅ Đã chèn 40 rows vào tPlannedTransactions (LOGIC ĐÚNG)';
PRINT '   - Bills (thay đổi): 11 rows';
PRINT '   - Recurring (cố định): 29 rows';
GO
